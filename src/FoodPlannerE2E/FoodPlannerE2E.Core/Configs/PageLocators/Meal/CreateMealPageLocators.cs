namespace FoodPlannerE2E.Core.Configs.PageLocators.Meal
{
    public class CreateMealPageLocators
    {
        ...
        public string IngredientUnitErrorMessage { get; set; }
        public string AddIngredientButton { get; set; }
