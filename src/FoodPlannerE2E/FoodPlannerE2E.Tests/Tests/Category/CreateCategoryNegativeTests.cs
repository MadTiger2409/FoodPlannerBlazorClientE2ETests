...
namespace FoodPlannerE2E.Tests.Tests.Category
{
	...
	public class CreateCategoryNegativeTests : CreateCategoryFixture
	{
		...
		public void Should_Not_Create_Category_When_Name_Is_Empty()
		{
			...
			CreateCategoryPage.HasErrorMessageWithGivenText(CreateEntityPageValidationMessages.Name.CanNotBeEmpty).Should().BeTrue();
		}
		...
		public void Should_Not_Create_Category_When_Name_Is_Too_Short()
		{
			...
			CreateCategoryPage.HasErrorMessageWithGivenText(CreateEntityPageValidationMessages.Name.MustBeOfMinimumLength).Should().BeTrue();
		}
		...
		public void Should_Not_Create_Category_When_Name_Is_Too_Long()
		{
			...
			CreateCategoryPage.HasErrorMessageWithGivenText(CreateEntityPageValidationMessages.Name.CanBeOfMaximumLength).Should().BeTrue();
		}
	}
}
